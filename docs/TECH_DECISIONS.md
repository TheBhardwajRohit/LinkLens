...
| 6 | Styling and motion | Tailwind CSS, Framer Motion | Fast to build a consistent dark theme; smooth card animations with reduced-motion support. | Plain CSS, GSAP | Decided |
